...
<form method="POST" style="text-align: center" action="<?php echo $serveurOK; ?>" target="iframePayment">
...
<h1 style="text-align: center">IFrame payment</h1>
<iframe name="iframePayment" title="iframe payment page" width="450" height="500" style="border: 1px solid;margin-left: 500px">
</iFrame>
