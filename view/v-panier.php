...
<div class="h-screen bg-gray-100 pt-20">
    ...
    <div class="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
        ...
        <?php $sous_total = array_sum(array_map(function($key) use ($produits_qtt, $produits_prix) {
        return $produits_qtt[$key] * $produits_prix[$key];
        }, array_keys($produits_id)));
        ...
        <div class="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
            <div class="mb-2 flex justify-between">
                ...
                <p class="text-gray-700"><?php echo $sous_total; ?> €</p>
            </div>
            ...
            <div class="flex justify-between">
                ...
                <div class="">
                    <p class="mb-1 text-lg font-bold"><?php echo $sous_total; ?> €</p>
